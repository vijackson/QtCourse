...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/430.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
#if QT_CONFIG(tooltip)
        actAbout->setToolTip(QCoreApplication::translate("QWMainWind", "\346\226\260\345\273\272\347\252\227\345\217\243", nullptr));
#endif // QT_CONFIG(tooltip)
